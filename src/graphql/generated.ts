...
export type ChallengeCreateInput = {
  cl4nkptwh061o01xpgm9v66uz?: InputMaybe<LessonCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  url: Scalars['String'];
};
...
export type ChallengeUpdateInput = {
  cl4nkptwh061o01xpgm9v66uz?: InputMaybe<LessonUpdateManyInlineInput>;
  url?: InputMaybe<Scalars['String']>;
};
...
export type AddNewSubscriberMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type AddNewSubscriberMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', id: string, lessonType: LessonType, publishedAt?: any | null, slug: string, title: string, videoId: string, description: string, teacher?: { __typename?: 'Teacher', name: string, bio: string, avatarUrl: string } | null, challenge?: { __typename?: 'Challenge', url: string } | null } | null };
...
export const AddNewSubscriberDocument = gql`
    mutation AddNewSubscriber($name: String!, $email: String!) {
  createSubscriber(data: {name: $name, email: $email}) {
    id
  }
}
    `;
export type AddNewSubscriberMutationFn = Apollo.MutationFunction<AddNewSubscriberMutation, AddNewSubscriberMutationVariables>;

/**
 * __useAddNewSubscriberMutation__
 *
 * To run a mutation, you first call `useAddNewSubscriberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddNewSubscriberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [addNewSubscriberMutation, { data, loading, error }] = useAddNewSubscriberMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useAddNewSubscriberMutation(baseOptions?: Apollo.MutationHookOptions<AddNewSubscriberMutation, AddNewSubscriberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddNewSubscriberMutation, AddNewSubscriberMutationVariables>(AddNewSubscriberDocument, options);
      }
export type AddNewSubscriberMutationHookResult = ReturnType<typeof useAddNewSubscriberMutation>;
export type AddNewSubscriberMutationResult = Apollo.MutationResult<AddNewSubscriberMutation>;
export type AddNewSubscriberMutationOptions = Apollo.BaseMutationOptions<AddNewSubscriberMutation, AddNewSubscriberMutationVariables>;
